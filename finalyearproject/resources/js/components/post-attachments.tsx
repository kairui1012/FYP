...
function SingleImage({
    ...
    return (
        <div
            className={`relative w-full overflow-hidden bg-zinc-200 cursor-zoom-in ${
        ...
        >
            ...
            <img
                ...
                style={{ maxHeight: compact ? 320 : 480 }}
            />
        </div>
    );
}
...
function ImageCarousel({
    ...
    const displayWidth = compact ? 520 : 760;
    ...
    return (
        ...
        >
            <div className="relative mx-auto h-full w-full" style={{ maxWidth: displayWidth }}>
                {images.map((src, index) => (
                    <img
                        ...
                        style={{ maxHeight: displayHeight, maxWidth: displayWidth }}
                    />
                ))}
            </div>
