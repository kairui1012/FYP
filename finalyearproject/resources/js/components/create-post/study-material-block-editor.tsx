...
const blockOptions: Array<{
    ...
    { type: 'video', icon: LinkIcon, labelKey: 'materialVideoBlock' },
];
                    ...
                    >
                        ...
                        {block.type === 'text' ? (
                            <textarea
                                ...
                                className="w-full resize-y rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm leading-6 text-zinc-800 outline-none transition placeholder:text-zinc-400 focus:border-violet-300 focus:bg-white focus:ring-2 focus:ring-violet-100"
                            />
                        ) : null}
                        ...
                        {block.type === 'video' ? (
                            <input
                                ...
                                placeholder={text.materialVideoPlaceholder}
                                className="w-full rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-800 outline-none transition placeholder:text-zinc-400 focus:border-violet-300 focus:bg-white focus:ring-2 focus:ring-violet-100"
                            />
                        ) : null}
