...
import {
    CONTENT_TYPES,
    hasActiveFilters,
} from '@/components/ts/features/categories/category-config';
import type {
    CategoriesPageProps,
    ContentTypeKey,
} from '@/components/ts/features/categories/category-types';
import type { PaginationMeta, PostItem } from '@/types';

export function useCategoryFilterControls(props: CategoriesPageProps) {
