...
import type { UserProgressData } from '@/components/ts/features/achievements/achievement-types';

type QuizAccuracySummaryProps = {
    userProgress: UserProgressData;
};

export function QuizAccuracySummary({
    userProgress,
}: QuizAccuracySummaryProps) {
