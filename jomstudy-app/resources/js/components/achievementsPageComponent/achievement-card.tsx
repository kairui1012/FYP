                    ...
                    <div className="mt-2 border-t border-zinc-100 pt-2 dark:border-zinc-700">
                        ...
                        {remaining > 0 && (
                            <p className="mt-0.5 text-xs text-zinc-400">
                                {remaining} {unit}{' '}
                                {trans('achievement.remaining')}
                            </p>
                        )}
                    </div>
                    <div className="absolute bottom-0 left-1/2 h-2 w-2 -translate-x-1/2 translate-y-1 rotate-45 border-r border-b border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-800" />
                </div>
            )}
        </article>
    );
