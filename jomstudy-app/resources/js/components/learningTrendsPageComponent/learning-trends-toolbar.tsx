...
import type {
    ...
    PopularSort,
    TransFn,
} from '@/components/ts/features/learning-trends/learning-trends-types';
                        ...
                        {RANGE_OPTIONS.map((option) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`my-0.5 flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition ${isActive ? 'bg-neutral-100 font-medium text-neutral-900' : 'text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900'}`}
                                >
