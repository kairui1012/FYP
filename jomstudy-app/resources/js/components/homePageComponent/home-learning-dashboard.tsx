...
import { transFromPage } from '@/components/ts/features/home-page/home-page-text';
import type { HomeLearningDashboardProps } from '@/components/ts/features/home-page/home-page-types';
import { getPostTypeBadgeProps } from '@/components/ts/shared/feed/feed-badge-utils';
import {
    Card,
    CardContent,
    CardDescription,
...
export function HomeLearningDashboard({
    overview,
    text,
    onOpenPost,
}: HomeLearningDashboardProps) {
    const page = usePage();
