            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                <div className="relative overflow-hidden rounded-2xl border border-dashed border-rose-200 bg-linear-to-br from-rose-50 via-white to-sky-50 px-5 py-12 text-center md:px-8 md:py-14">
                    <div className="mx-auto flex max-w-lg flex-col items-center">
                        ...
                        <h2 className="text-lg font-bold text-zinc-900">{noBadgesYetLabel}</h2>
                        ...
                        >
                            ...
                            <div className="mb-2 flex items-center gap-2">
                                ...
                                >
                                    <BadgeIcon
                                        ...
                                        className={cn(
                                            'h-4.5 w-4.5',
                                            isFeatured ? 'text-amber-600 dark:text-amber-400' : 'text-zinc-500',
                                        )}
                                    />
                                </div>
                                <p
                                    className={cn(
                                        'font-bold',
                                        isFeatured ? 'text-amber-800 dark:text-amber-200' : 'text-zinc-900 dark:text-zinc-100',
                                    )}
                                >
                            ...
                            <p
                                className={cn(
                                    ...
                                    isFeatured ? 'text-amber-700 dark:text-amber-300' : 'text-zinc-600 dark:text-zinc-400',
                                )}
                            >
                            ...
                            <p
                                className={cn(
                                    'mt-2 text-xs',
                                    isFeatured ? 'text-amber-600 dark:text-amber-400' : 'text-zinc-400',
                                )}
                            >
