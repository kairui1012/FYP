...
export function BtnCreatePost() {
    ...
    return (
        <Button
            asChild
            variant="outline"
            className="h-8 rounded-full border-2 border-[#ef99b0] bg-linear-to-r from-[#ef99b0] to-[#e27193] text-xs text-white transition-all duration-200 hover:border-[#d85380] hover:from-[#f5c4d6] hover:to-[#f39db8] hover:text-black hover:shadow-[0_4px_12px_rgba(227,106,139,0.3)] focus-visible:border-[#d85380] focus-visible:ring-[#e36a8b]/35 md:h-9 md:text-sm md:mr-[5%] inline-flex dark:border-[#ef99b0] dark:bg-linear-to-r dark:from-[#ef99b0] dark:to-[#e27193] dark:text-white dark:hover:border-[#d85380] dark:hover:from-[#f5c4d6] dark:hover:to-[#f39db8] dark:hover:text-black dark:hover:shadow-[0_4px_12px_rgba(227,106,139,0.3)] dark:focus-visible:border-[#d85380]"
        >
            <Link href="/createPostPage" prefetch className="flex items-center gap-1">
