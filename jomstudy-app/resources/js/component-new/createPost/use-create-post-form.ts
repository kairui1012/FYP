...
// file-upload validation, AI question
...
// Build a new study-material content block; id uses timestamp + random for uniqueness
...
export function useCreatePostForm({
    ...
    // Whether the material has at least one valid block (text has content or a file is uploaded)
