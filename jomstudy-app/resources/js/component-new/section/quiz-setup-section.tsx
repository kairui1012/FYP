...
import type { QuizAiAnswerPlacement, QuizItem } from '../config/create-post-config';
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border-0 bg-white px-4 py-3 text-sm text-zinc-800 transition outline-none placeholder:text-zinc-500 focus:bg-zinc-100 focus:ring-0 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:bg-zinc-700"
                                            />
                                        </div>
                                    );
                                })}
